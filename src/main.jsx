...
const App = () => {
  ...
  // University of Michigan Official Brand Colors
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 pb-12">
      ...
      <nav className="bg-white border-b sticky top-0 z-50 shadow-sm">
        <div className="max-w-5xl mx-auto px-4 flex items-center justify-between h-16">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg tracking-tight text-slate-800">Funding Portfolio</span>
          </div>
      ...
      <main className="max-w-5xl mx-auto px-4 pt-8">
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            ...
            <div 
              className="p-5 rounded-xl border flex items-center gap-6 shadow-inner"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            <section className="bg-white rounded-xl shadow-sm border overflow-hidden">
              ...
              <div className="p-6">
                <p className="text-slate-600 leading-relaxed mb-6">
                  "From the first time I set foot on the University of Michigan campus as a 6-year-old, I knew I was meant to be a Wolverine. My journey through high school has been defined by excellence in the classroom, leadership on the athletic field, and a commitment to service. This bridge funding represents the final step in realizing a lifelong dream of becoming part of the Michigan legacy."
                </p>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  {[
                    ...
                    <div key={i} className="group relative aspect-square bg-slate-50 rounded-lg border-2 border-dashed border-slate-200 flex flex-col items-center justify-center overflow-hidden hover:border-[#00274C] transition-all cursor-pointer text-center p-2 hover:bg-white hover:shadow-md">
            ...
            <div className="bg-white rounded-xl shadow-sm border min-h-[450px]">
              ...
              <div className="p-8">
                {activeTab === 'profile' && (
                   <div className="animate-in fade-in slide-in-from-bottom-2 duration-500">
                     <h3 className="text-xl font-bold mb-4 text-[#00274C]">Mission & Vision</h3>
                     <p className="text-slate-600 leading-relaxed italic border-l-4 border-yellow-400 pl-4 py-2 text-lg">
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                        <div className="bg-slate-50 p-5 rounded-xl border border-slate-200 hover:shadow-sm transition-shadow">
                          <h4 className="font-bold text-[#00274C] mb-2 uppercase text-xs tracking-widest">Primary Goal</h4>
                          <p className="text-sm text-slate-600 leading-relaxed">Secure bridge funding to cover housing and essential academic materials for the upcoming Freshman year.</p>
                        </div>
                        <div className="bg-slate-50 p-5 rounded-xl border border-slate-200 hover:shadow-sm transition-shadow">
                          <h4 className="font-bold text-[#00274C] mb-2 uppercase text-xs tracking-widest">Academic Focus</h4>
                          <p className="text-sm text-slate-600 leading-relaxed">Accepted into the university, pursuing a degree with long-term goals in leadership and innovation.</p>
                        </div>
                     </div>
                   </div>
                )}
                {activeTab === 'academics' && (
                  <div className="animate-in fade-in slide-in-from-bottom-2 duration-500">
                    <h3 className="text-xl font-bold mb-4 flex items-center gap-2 text-[#00274C]">Top Academic Honors</h3>
                    <ul className="space-y-4">
                      {[
                        { title: "National Honor Society", detail: "Member since Sophomore year, maintaining consistent 4.0 GPA." },
                        { title: "AP Scholar with Distinction", detail: "Recognized for exceptional achievement on college-level exams." },
                        { title: "Top 5% of Graduating Class", detail: "Consistent placement in the highest academic decile." }
                      ].map((item, i) => (
                        <li key={i} className="flex gap-4 p-4 rounded-lg bg-slate-50 border border-slate-100 group hover:bg-white hover:shadow-sm transition-all">
                          <div className="bg-[#E6E9ED] p-2 rounded h-fit group-hover:bg-[#00274C] group-hover:text-white transition-colors">
                ...
                {activeTab === 'athletics' && (
                  <div className="animate-in fade-in slide-in-from-bottom-2 duration-500">
                    <h3 className="text-xl font-bold mb-6 text-[#00274C]">Athletic Leadership</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                      <div className="bg-blue-50 p-6 rounded-xl border border-blue-100 text-center shadow-sm">
                        <p className="text-3xl font-black text-[#00274C]">Team Captain</p>
                        <p className="text-xs uppercase font-bold text-slate-500 tracking-widest mt-1">Varsity Leadership</p>
                      </div>
                      <div className="bg-blue-50 p-6 rounded-xl border border-blue-100 text-center shadow-sm">
                        <p className="text-3xl font-black text-[#00274C]">All-District</p>
                        <p className="text-xs uppercase font-bold text-slate-500 tracking-widest mt-1">Recognition</p>
                      </div>
                    </div>
                  </div>
                )}
                {activeTab === 'extra' && (
                  <div className="animate-in fade-in slide-in-from-bottom-2 duration-500">
                    <h3 className="text-xl font-bold mb-4 text-[#00274C]">Service & Involvement</h3>
                    <div className="space-y-6">
                      <div className="flex gap-4">
                        <div className="w-12 h-12 rounded-full bg-emerald-50 text-emerald-600 flex items-center justify-center shrink-0 shadow-sm border border-emerald-100">
                            <Users className="w-6 h-6" />
                        </div>
                        <div>
                            <h4 className="font-bold text-slate-800 text-lg">Community Volunteer</h4>
                            <p className="text-slate-600 mt-1">Logged over 150 hours of community service across multiple local organizations.</p>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <section className="bg-white rounded-xl shadow-sm border overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                <div className="flex justify-between items-end">
                  <span className="text-sm text-slate-500 font-medium">4-Year Estimated Cost</span>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between text-sm py-1 border-t-2 border-dashed border-slate-100 pt-2 font-bold">
                    <span className="text-[#00274C] uppercase text-[10px] tracking-widest">Remaining Bridge</span>
                    <span className="text-[#00274C] font-black text-lg">${(data.fundingGoal - data.currentFunding).toLocaleString()}</span>
                  </div>
                </div>
                <button 
                  className="w-full text-white font-bold py-3 rounded-lg hover:opacity-90 transition-all flex items-center justify-center gap-2 mt-4 shadow-lg shadow-blue-900/20 active:scale-95"
            ...
            <section className="bg-white rounded-xl shadow-sm border overflow-hidden">
              ...
              <div className="p-6 space-y-6">
                <div className="italic text-slate-600 text-sm leading-relaxed border-l-4 border-[#00274C] pl-4">
                  "He embodies the 'Leaders and Best' spirit every single day, both on and off the field."
                  <p className="mt-2 font-bold text-[#00274C] not-italic">— Coach Johnson</p>
                </div>
              </div>
            </section>

            <div 
              className="p-6 rounded-xl text-white text-center shadow-xl transform hover:scale-[1.02] transition-transform"
              style={{ backgroundColor: UM_BLUE }}
            >
              ...
              <p className="text-[10px] opacity-75 font-medium leading-tight">
                Watch a personal message about my goals for Michigan.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Footer */}
      <footer className="max-w-5xl mx-auto px-4 mt-16 text-center text-slate-400 text-xs border-t pt-8">
        <p>© 2025 [Family Name] • Michigan Funding Portfolio</p>
        <p className="mt-2 font-bold tracking-[0.2em]" style={{ color: UM_BLUE }}>GO BLUE!</p>
      </footer>
    </div>
  );
};
